...
firewall rejects schema drift and keeps host paths and bearer material out of model
input. See [Runner conformance](runner-conformance.md) for the adapter matrix.
