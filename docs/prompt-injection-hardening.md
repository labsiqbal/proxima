...
fixed path-free developer policy before provider forwarding. The provider bearer
remains only in its HTTP header. The schema-validated `MasterToolBroker` accepts only
