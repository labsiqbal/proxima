...
| [evidence/inbox-destination/README.md](evidence/inbox-destination/README.md) | Disposable real-browser capture of the Inbox destination and the ephemeral header at desktop and 390px in both themes, plus the dismiss/persistence assertions and the two phone-width sheet bugs it exposed (#157/#158) | by hand (recipe in that README) |
