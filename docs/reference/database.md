...
SQLite (WAL mode). 56 tables. Applied migration version: **57**. This is the exact shape a fresh install gets from `init_db` + versioned migrations. Per-install data lives at `~/.local/share/proxima/proxima.db` (outside the repo).
...
---
_Generated 2026-08-02 09:10 UTC._
