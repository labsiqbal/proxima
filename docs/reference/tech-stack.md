...
| Browser accessibility QA | **Lighthouse 13** + Chrome DevTools Protocol | disposable auth/onboarding flows, accessibility trees, theme contrast, and retained screenshots |
