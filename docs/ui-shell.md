...
marker. Closing that inspection, changing Projects, or opening Files normally clears
the Container-root target and restores the ordinary virtual Files view. Changing
