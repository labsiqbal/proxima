...
// folder to work in. Link an existing folder, create a new empty one on disk, or
// skip to use the starter project Proxima created under its data dir.
    ...
    <div className="center-screen">
      <div className="onboard-card">
        ...
        <p className="auth-sub">
          ...
          operate on its files. Link a folder you already have, create a new empty one
          on disk, or skip to use the starter project.
        </p>
