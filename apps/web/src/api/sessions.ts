...
export const listMessages = (token: string, sessionId: number, signal?: AbortSignal) => api<{ messages: ChatMessage[]; goal: GoalState | null }>(`/api/sessions/${sessionId}/messages`, token, { signal })
