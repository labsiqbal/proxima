...
const STORAGE_KEYS = {
  sessionCount: "proxima.videoStudio.feedbackSessionCount",
  lastPromptedAt: "proxima.videoStudio.feedbackLastPromptedAt",
} as const;
...
const SESSION_COUNTED_KEY = "proxima.videoStudio.feedbackSessionCounted";
