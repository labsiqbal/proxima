    ...
    <div className="border-b border-neutral-800/40 bg-neutral-950/96">
      <div className="flex items-center justify-between px-3 py-2">
        <div className="flex items-center gap-3">
          ...
          {STUDIO_RAZOR_TOOL_ENABLED && (
            <div className="proxima-tool-switch flex items-center rounded-md overflow-hidden">
              <Tooltip label="Selection tool (V)">
                <button
                  type="button"
                  onClick={() => setActiveTool("select")}
                  className={`proxima-tool-button flex h-6 w-6 items-center justify-center transition-colors ${activeTool === "select" ? "is-active" : ""}`}
                >
              ...
              <Tooltip label="Razor tool (B)">
                <button
                  ...
                  className={`proxima-tool-button flex h-6 w-6 items-center justify-center transition-colors ${activeTool === "razor" ? "is-active" : ""}`}
                >
                  <Scissors size={11} />
                </button>
              </Tooltip>
