...
function ProximaStudioLogo() {
  return (
    <div className="proxima-studio-brand flex items-center gap-2">
      <ProximaMark className="proxima-studio-brand-mark" />
      <span className="proxima-studio-brand-name">Proxima Video</span>
    </div>
  );
}
...
export function StudioHeader({
  ...
  return (
    <div className="proxima-studio-header flex items-center justify-between h-10 px-3 flex-shrink-0">
      {/* Left: Proxima brand */}
