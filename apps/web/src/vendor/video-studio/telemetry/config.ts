...
//   localStorage.setItem('proxima.videoStudio.telemetryDisabled','1')
// ---------------------------------------------------------------------------

import { generateId } from "../utils/generateId";

const ANON_ID_KEY = "proxima.videoStudio.anonymousId";
const OPT_OUT_KEY = "proxima.videoStudio.telemetryDisabled";
const NOTICE_KEY = "proxima.videoStudio.telemetryNoticeShown";
...
const SESSION_FIRED_KEY = "proxima.videoStudio.sessionStartFired";
