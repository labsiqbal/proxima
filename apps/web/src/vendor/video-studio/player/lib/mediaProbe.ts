...
type MediaProbeMediabunny = Pick<
  typeof import("mediabunny"),
  "Input" | "UrlSource" | "MP4" | "QTFF" | "WEBM" | "MATROSKA" | "MP3" | "WAVE" | "OGG" | "ADTS"
>;

let mediabunnyModule: (Pick<MediaProbeMediabunny, "Input" | "UrlSource"> & {
  formats: Array<
    MediaProbeMediabunny[
      "MP4" | "QTFF" | "WEBM" | "MATROSKA" | "MP3" | "WAVE" | "OGG" | "ADTS"
    ]
  >;
}) | null | false = null;
...
async function loadMediabunny() {
  ...
  try {
    ...
    mediabunnyModule = {
      Input: mb.Input,
      UrlSource: mb.UrlSource,
      formats: [mb.MP4, mb.QTFF, mb.WEBM, mb.MATROSKA, mb.MP3, mb.WAVE, mb.OGG, mb.ADTS],
    };
