      ...
      import("@hyperframes/player").then(() => {
        ...
        if (player.shadowRoot) {
          ...
          pasteboardStyle.textContent =
            ...
            ".hfp-iframe{box-shadow:0 0 0 1px var(--proxima-video-border, rgba(15,23,42,.14)),0 18px 42px rgba(15,23,42,.16)}";
    ...
    return (
      ...
      >
        ...
        {showCompositionOverlay && (
          <div
            className="proxima-preview-loading absolute inset-0 flex items-center justify-center z-30 select-none"
        ...
        {showAssetOverlay && (
          <div
            className="proxima-preview-loading absolute inset-0 flex items-center justify-center z-20 select-none"
            data-hyperframes-ignore=""
            draggable={false}
            style={{
